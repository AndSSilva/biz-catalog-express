...
import { BarChart3, Boxes, ExternalLink, LogOut, Package, Ruler, Settings, Tags } from "lucide-react";
...
const measurementsLink = { to: "/admin/medidas", label: "Medidas", icon: Ruler } as const;
