  ...
  return (
    ...
    >
      <div className="relative aspect-4/3 w-full overflow-hidden bg-muted">
        ...
        {product.on_sale && (
          <span className="absolute right-3 top-3 inline-flex items-center gap-1 rounded-full bg-destructive px-3 py-1 text-xs font-semibold text-destructive-foreground shadow-sm">
